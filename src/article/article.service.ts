...
export class ArticleService {
  ...
  // //--------------------
  // returnArticlesArray(updateIdsDto: ReturnArticleDto): Array<ArticleModel> {
  //   return updateIdsDto.ids.map((el) => {
  //     return {
  //       id: el,
  //       publisher_id: el,
  //       publisher_logo_url: el.toString(),
  //       publisher_name: el.toString(),
  //       story_id: el,
  //       title: el.toString(),
  //     };
  //   });
